            ...
            <div class="bg-white border border-slate-200 shadow-sm rounded-2xl p-5 mb-8">
                <div class="flex flex-col md:flex-row gap-5">
                    ...
                    <div class="w-full md:w-72">
                         <div class="relative">
                            <select id="category-filter" class="appearance-none block w-full rounded-xl border border-slate-300 bg-white py-2.5 pl-3 pr-10 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm text-slate-700 transition-colors">
    ...
    <script>
        ...
        window.openEditModal = function(button) {
            ...
            document.querySelectorAll('input[name="categories[]"]').forEach(cb => {
                cb.checked = false;
                // Visual reset handled by CSS peer-checked
            });
